...
IMAGES_DIR = os.path.join(PATHFINDING_DIR, 'images')  # images文件夹路径
...
class PathfindingMazeApp:
    ...
    def draw_search_step(self, step):
        ...
        self.ax.set_title('{} Algorithm Searching... (Step {}/{})'.format(
    ...
    def draw_final_result(self):
        ...
        if self.path:
            ...
            self.ax.set_title('Search Complete! Shortest Path Length: {}'.format(path_length), 
                           fontsize=12, fontweight='bold', color='green')
            self.update_info("搜索完成！\n最短路径长度: {}\n已访问节点数: {}".format(
                path_length, len(self.visited)))
        else:
            self.ax.set_title('Path Not Found', fontsize=12, fontweight='bold', color='red')
    ...
    def draw_maze(self):
        ...
        self.ax.set_aspect('equal')
        self.ax.axis('off')
        self.ax.set_title('Maze (Green=Start, Red=Goal)', fontsize=12, fontweight='bold')
    ...
    def draw_step_to_image(self, step, step_num, total_steps):
        ...
        ax.set_title('{} Algorithm Searching... (Step {}/{})'.format(
    ...
    def generate_gif(self):
        ...
        try:
            ...
            if self.path:
                ...
                ax.set_title('Search Complete! Shortest Path Length: {}'.format(path_length), 
                           fontsize=12, fontweight='bold', color='green')
